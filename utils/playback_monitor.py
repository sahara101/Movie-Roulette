...
class PlaybackMonitor(threading.Thread):
    ...
    def should_update_poster(self, username, service):
        ...
        if self.display_mode == 'first_active':
            ...
            return not os.path.exists(path_manager.get_path('current_movie'))
    ...
    def is_poster_user(self, username, service):
        ...
        if display_mode == 'preferred_user':
            ...
            if preferred and preferred.get('username') == username and preferred.get('service') == service:
                ...
                if os.path.exists(path_manager.get_path('current_movie')):
                    os.remove(path_manager.get_path('current_movie'))
                return True
            ...
            should_update = not os.path.exists(path_manager.get_path('current_movie'))
            if should_update:
                        ...
                        if movie_id:
                            ...
                            if movie_data:
                                ...
                                can_update = (
                                    ...
                                    not os.path.exists(path_manager.get_path('current_movie')) or
                                ...
                                if can_update and (movie_id != self.current_movie_id or not os.path.exists(path_manager.get_path('current_movie'))):
